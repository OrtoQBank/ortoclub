...
export default function Video1Section() {
    return (
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="text-green-400 w-6 h-6 mt-0.5 shrink-0" />
                  <div>
                    <h4 className="text-white font-semibold mb-1">Questões práticas e comentadas em profundidade</h4>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="text-green-400 w-6 h-6 mt-0.5 shrink-0" />
                  <div>
                    <h4 className="text-white font-semibold mb-1">Simulados no formato real do TEOT</h4>
                    <p className="text-white/80 text-sm leading-relaxed">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="text-green-400 w-6 h-6 mt-0.5 shrink-0" />
                  <div>
                    <h4 className="text-white font-semibold mb-1">Provas antigas</h4>
                    <p className="text-white/80 text-sm leading-relaxed">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="text-green-400 w-6 h-6 mt-0.5 shrink-0" />
                  <div>
                    <h4 className="text-white font-semibold mb-1">Área de feedback e acompanhamento contínuo</h4>
                    <p className="text-white/80 text-sm leading-relaxed">
      ...
      {/* SEÇÃO DE CARDS */}
      <section className="py-12 md:py-20 px-4 bg-[#f0f4f8]">
        <div className="container mx-auto">
