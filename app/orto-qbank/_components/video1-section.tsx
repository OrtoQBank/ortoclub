          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid items-center gap-8 lg:grid-cols-12">
              ...
              <div className="lg:col-span-3 space-y-6">
                <div>
                  <h2 className="text-2xl font-semibold mb-3 text-white">Nossa metodologia</h2>
                ...
                <ul className="space-y-3 text-white">
                  <li className="flex items-start gap-2 ">
                    <CheckCircle2 className="text-white w-5 h-5 text-primary mt-0.5 shrink-0" />
              ...
              <div className="lg:col-span-6">
                ...
                <div className="mt-4 flex flex-col items-center">
                        ...
                        <a
                          ...
                          className="bg-white text-brand-blue border-4 border-white px-6 py-2 rounded-lg font-semibold hover:bg-white/90"
                        >
                          Garantir Acesso
                        </a>
                      </div>
              ...
              <div className="lg:col-span-3 space-y-6">
                <div>
                  <h2 className="text-2xl font-semibold mb-3 text-white">O que você vai conquistar</h2>
                  <p className="text-muted-foreground leading-relaxed text-white">
